...
| TD-011 | `WORKTECH_API_BASE_URL` зашит в коде (нет env-переменной) | Историческое; локально требуется ручная правка/прокси | LOW: неудобство локальной разработки | OPEN |
