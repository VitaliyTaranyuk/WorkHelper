...
| TD-025 | GlitchTip на проде не принимает события: в консоли `Invalid Sentry Dsn: https://…@wowoffcata.hlab.kz/1` | Конфигурация DSN (ТП-175) | MEDIUM: мониторинг клиентских ошибок фактически не работает — ошибки прода не собираются. Обнаружено 2026-07-27; та же строка есть в бандле от 7 июля, то есть дефект не связан с деплоем ТП-212 | OPEN |
