...
export const VOICE_ONBOARDING_STEPS = [
  ...
  {
    title: 'Как запустить',
    text: 'Нажмите кнопку микрофона внизу справа или клавиши Ctrl+Shift+M. Говорите свободно — весь текст накапливается; чтобы завершить, скажите «Работаем» или нажмите «Стоп».',
  },
  {
    title: 'Подтверждение',
