...
export const sprintCommand = taskAttributeCommand({
  ...
  // Требуем глагол переноса или «бэклог» — иначе «создай спринт …» (создание
  // спринта, а не перенос задачи) ловилось бы словом «спринт».
  trigger: /(перенеси|перемести|переместить|бэклог|беклог)/iu,
