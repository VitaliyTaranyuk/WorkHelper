...
export interface UpdateTasksSprintRequestDto {
  /**
   * Проект задачи
   * @example "id проекта"
   */
...
export interface ActionLogsDtoRequest {
  /**
   * Стартовое время в диапазоне поиска
   * @format date-time
   */
  startTime: string;
  /**
   * Конечное время в диапазоне поиска
   * @format date-time
   */
  endTime: string;
  /**
...
export interface ActionLogDto {
  ...
  action:
    ...
    | "EMAIL_CONF_FAILURE";
  /**
   * Время, в которое совершено действие
   * @format date-time
   */
  actionTime: string;
}
...
export interface TgLinkResponse {
  link?: string;
}
...
export interface AttachToCommentRequest {
  commentId: string;
...
export interface SprintListDto {
  sprints?: SprintMinDto[];
}

export interface SprintMinDto {
  /** Ид спринта */
  id: string;
  /** Описание спринта */
  description?: string;
...
export interface SprintInfoListDto {
  sprints?: SprintInfoDTO[];
}
...
export type UpdateTasksSprintData = any;

export type UpdateTasksSprintError = ErrorResponse;
...
export type GetActionLogData = PageActionLogDto;

export type GetActionLogError = ErrorResponse;
...
export type RegisterUserData = InfoResponse;
...
export type EnableNotificationData = ApiResponse;

export type EnableNotificationError = ErrorResponse;

export type DisableNotificationData = ApiResponse;

export type DisableNotificationError = ErrorResponse;

export type CreateLinkTokenData = TgLinkResponse;

export type CreateLinkTokenError = ErrorResponse;
...
export type UploadAttachmentData = AttachmentResponseDto;

export type UploadAttachmentError = ErrorResponse;

export type AttachToCommentData = ApiResponse;

export type AttachToCommentError = ErrorResponse;
...
export type GetUserProjectTasksData = TaskListDto;

export type GetUserProjectTasksError = ErrorResponse;
...
export type FindTaskByCodeData = TaskDataDto;

export type FindTaskByCodeError = ErrorResponse;
...
export type GetSprintListData = SprintListDto;

export type GetSprintListError = ErrorResponse;

export type GetSprintInfoData = SprintInfoDTO;

export type GetSprintInfoError = ErrorResponse;

export type GetSprintInfoListData = SprintInfoListDto;

export type GetSprintInfoListError = ErrorResponse;
...
export type GetActiveProjectData = IdResponse;
...
export type ConfirmEmailData = ConfirmationResponse;
...
export type DownloadAttachmentError = ErrorResponse;
